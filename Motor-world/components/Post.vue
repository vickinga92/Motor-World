...
export default {
  ...
  data() {
    const {
      ...
      desc = "",
      image = []     
    } = this.$store.state.OnePost;  

    return {
      displacements: [
        { id: 1, displacement: "49" }, { id: 2, displacement: "125" },
        { id: 3, displacement: "250" }, { id: 4, displacement: "500" },
        { id: 5, displacement: "600" }, { id: 6, displacement: "750" },
        { id: 7, displacement: "1000" }, { id: 8, displacement: "1200" },
      ],
      types: [
        { id: 1, type: "SCOOTERS" }, { id: 2, type: "CICLOMOTOR" }, { id: 3, type: "SPORT" },
        { id: 4, type: "NAKED" }, { id: 5, type: "SUPERMOTARD" }, { id: 6, type: "ENDURO" }, { id: 7, type: "TRAIL" },
      ],
      image: [],  
